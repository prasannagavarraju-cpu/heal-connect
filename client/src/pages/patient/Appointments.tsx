...
import { Calendar, Phone, Video, Home, Clock, Plus } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-200 text-sm mt-1">{appointments.length} total appointments</p>
            </div>
            <button className="flex items-center gap-2 bg-white/10 border border-white/20 text-white font-medium px-4 py-2.5 rounded-xl hover:bg-white/20 transition-colors">
                ...
                <div key={appt.id} className="card hover:shadow-md transition-all animate-slide-up">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-bold text-slate-900">Dr. {appt.doctor?.name}</p>
                        <p className="text-sm text-slate-500">{appt.doctor?.doctorProfile?.specialization}</p>
